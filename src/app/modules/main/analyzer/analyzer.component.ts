...
import TranscriptFacade from 'src/app/core/facades/transcript.facade';
...
export default class AnalyzerComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private transcripts: TranscriptFacade
  ) {
  }
  activeTranscript$  =  this.transcripts.activeTranscript$
  filteredTranscript$ = this.transcripts.filteredTranscript$;
  panel1Title$= this.transcripts.panel1Title$
  panel2Title$= this.transcripts.panel2Title$
